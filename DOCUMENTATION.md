...
The `{analysis}/metadata.tsv` file maps sequencing experiment IDs to samples and replicates. It is generated by running `python mlip/dataflow.py preprocess` and must be edited before running the `flow` step.
